export type ContentStatus = "proposed" | "accepted" | "in_production" | "published" | "archived" | "verified";
export type DiscussionStatus = "open" | "locked" | "featured";
export type TopicCategory = "Hukum Perusahaan" | "Hukum Perdata" | "Hukum Pidana" | "Hukum Keluarga" | "Hukum Internasional" | "Hukum Teknologi Digital" | "Hukum Ketenagakerjaan" | "Hukum Tata Negara";
export type TopicId = string & {
    readonly __topicId: unique symbol;
};
export declare function TopicId(value: string): TopicId;
export type ContentId = string & {
    readonly __contentId: unique symbol;
};
export declare function ContentId(value: string): ContentId;
export type DiscussionId = string & {
    readonly __discussionId: unique symbol;
};
export declare function DiscussionId(value: string): DiscussionId;
...
//# sourceMappingURL=community.contracts.d.ts.map