...
export type CapabilityRequirementSource = "workspace-permission" | "slot-default" | "slot-defaultExperience" | "slot-capabilityIds" | "navigation-item";
...
export type DependencyKind = "capability" | "plugin" | "lazy-bundle" | "remote-endpoint" | "product-extension" | "tenant-override";
