...
export type Arch16ViolationKind = "runtime-imports-normalizer" | "runtime-imports-planner" | "runtime-imports-graph-builder" | "runtime-imports-descriptor-kernel" | "runtime-performs-normalization" | "runtime-performs-planning" | "runtime-performs-graph-construction" | "runtime-performs-descriptor-interpretation" | "runtime-depends-on-compiler-module";
...
export type VerifyArch16Fn = (target: Arch16BoundaryTarget, options?: {
    readonly strict?: boolean;
    readonly collectDependencyGraph?: boolean;
