    ...
    <div className="min-h-screen bg-surface-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <header className="mb-10 sm:mb-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-text-primary tracking-tight mb-3">Apa yang ingin Anda capai?</h1>
          <p className="text-base text-text-secondary max-w-xl mx-auto leading-relaxed">
            Jelaskan kebutuhan Anda dalam bahasa alami. EOS akan memahami, mengontekstualisasikan, dan membentuk Work yang tepat untuk Anda.
          </p>
        </header>
