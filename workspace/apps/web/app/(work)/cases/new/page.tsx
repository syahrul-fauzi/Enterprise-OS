...
// import { ProductCasesPage } from "@repo/presentation-widgets"; // Deprecated package - golden spine only
...
export default async function NewCaseRoute({ params, searchParams }: NewCaseRouteProps) {
  ...
  const binding = readProductBinding(productId);
  return <ProductCasesPage productId={productId} binding={binding} session={session} isNewCase={true} />;
}