      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Requirement Management</h1>
              <p className="mt-2 max-w-3xl text-sm text-gray-600">
                Reuses the canonical requirement-management experience surface for
                direct requirement operations in LawyersHub.
              </p>
            </div>
          </div>
