...
import CaseView from "../../../../capabilities/legal-case/experience/views/CaseView";
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-gray-600">
                Reuses the canonical legal-case experience surface for direct
                LawyersHub case operations.
              </p>
            </div>
          </div>
